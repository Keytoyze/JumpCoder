...
case "$1" in
    ...
    --evaluate)
        python evaluate.py --port_infilling $PORT_INFILLING --port_generation $PORT_GENERATION --dataset_path dataset/multi_cpp.json --save_name results/cpp-cl-7b-instruct.json --speculative_infill --parallel_generate_with_infill --topk_infilling 10 --threshold_improvement 0.8
        ;;
esac